...
public class DAOFactory {
    ...
    /**
     * Obté una instància de DAOUsuari
     * 
     * @return Implementació de IDAOUsuari per Oracle
     * @throws Exception Si hi ha error de connexió
     */
    public static IDAOUsuari getDAOUsuari() throws Exception {
        return new DAOUsuari();
    }
